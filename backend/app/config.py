...
DEFAULT_SECRET = 'development-secret-development-secret-development-secret-development-secret'
...
class Settings:
    ...
    def from_env(cls):
        ...
        settings = cls(
            ...
            polza_api_base_url=os.getenv('POLZA_API_BASE_URL', 'https:/polza.ai/api/v1'),
